...
if (isset($_POST["login_user_with_service"])) {
	//this is service list array
	$service_list = $_POST["service_id"];
	//here we are converting array into json format because array cannot be store in cookie
	$json_e = json_encode($service_list);
	//here we are creating cookie and name of cookie is service_list
	setcookie("service_list",$json_e,strtotime("+1 day"),"/","","",TRUE);
