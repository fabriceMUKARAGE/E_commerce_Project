$(document).ready(function(){
	...
	//service() is a funtion fetching service record from database whenever page is load
		function service(){
		$.ajax({
			url	:	"action.php",
			method:	"POST",
	...
	/*	when page is load successfully then there is a list of categories when user click on category we will get category id and 
		according to id we will show services
	*/
	$("body").delegate(".category","click",function(event){
		$("#get_service").html("<h3>Loading...</h3>");
	...
	/*	when page is load successfully then there is a list of brands when user click on brand we will get brand id and 
		according to brand id we will show services
	*/
	...
	/*
		At the top of page there is a search box with search button when user put name of service then we will take the user 
		given string and with the help of sql query we will match user given string to our database keywords column then matched service 
		we will show
	*/
	...
	*/
	...
	$("body").delegate("#service","click",function(event){
	...
	//Add service into Cart End Here
	...
	//Change the number of fliers needed end here 

	/*
		whenever user click on .remove class we will take service id of that row 
		and send it to action.php to perform service removal operation
	*/
	...
	/*
		whenever user click on .update class we will take service id of that row 
		and send it to action.php to perform service qty updation operation
	*/
	...
	/*
		...
		getCartItem is used to show the list item into dropdown menu 
		checkOutDetails is used to show list item into Cart.php page
	*/
	...
	*/
	...
	$("body").delegate("#page","click",function(){
		...
		$.ajax({
			url	:	"action.php",
			method	:	"POST",
			data	:	{getservice:1,setPage:1,pageNumber:pn},
			success	:	function(data){
				$("#get_service").html(data);
			}
		})
